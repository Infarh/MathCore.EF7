...
namespace MathCore.EF7.Controllers
{
    ...
    public class ControllerBaseActionResultApi<T, TKey> : ControllerBase where T : IEntity<TKey>
    {
        ...
        public virtual async Task<IActionResult> IsEmpty(CancellationToken Cancel = default)
        {
        ...
        public virtual async Task<IActionResult> ExistId(TKey Id, CancellationToken Cancel = default)
        {
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(bool))]
        [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(bool))]
        public virtual async Task<IActionResult> Exist(T item, CancellationToken Cancel = default)
        {
        ...
        public virtual async Task<IActionResult> GetCount(CancellationToken Cancel = default)
        {
        ...
        public virtual async Task<ActionResult<IEnumerable<T>>> GetAll(CancellationToken Cancel = default)
        {
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public virtual async Task<IActionResult> GetById(TKey Id, CancellationToken Cancel = default)
        {
        ...
        [HttpPost("range")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        public virtual async Task<IActionResult> AddRange(IEnumerable<T> items, CancellationToken Cancel = default)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public virtual async Task<IActionResult> Update(T item, CancellationToken Cancel = default)
        {
        ...
        [ProducesResponseType(StatusCodes.Status202Accepted)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public virtual async Task<IActionResult> UpdateById(TKey id, Action<T> ItemUpdated, CancellationToken Cancel = default)
        {
        ...
        [HttpPut("range")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        public virtual async Task<IActionResult> UpdateRange(IEnumerable<T> items, CancellationToken Cancel = default)
        {
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public virtual async Task<IActionResult> Delete(T item, CancellationToken Cancel = default)
        {
        ...
        [HttpDelete("range")]
        [ProducesResponseType(StatusCodes.Status200OK)]
        public virtual async Task<IActionResult> DeleteRange(IEnumerable<T> items, CancellationToken Cancel = default)
        {
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public virtual async Task<IActionResult> DeleteById(TKey id, CancellationToken Cancel = default)
        {
        ...
        [HttpPut("save")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(int))]
        public virtual async Task<IActionResult> SaveChanges(CancellationToken Cancel = default)
        {
