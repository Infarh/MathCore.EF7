...
namespace MathCore.EF7.Interfaces.Repositories
{
    ...
    public interface IGPSRepository<TGpsEntity, in TKey> : IRepository<TGpsEntity, TKey> where TGpsEntity : IGPSEntity<TKey>, IEntity<TKey>
    {
        ...
        Task<IEnumerable<TGpsEntity>> GetAllByLocationInRange(double Latitude, double Longitude, double RangeInMeters, CancellationToken Cancel = default);
        ...
        Task<IEnumerable<TGpsEntity>> GetAllByLocationInRange(double Latitude, double Longitude, double RangeInMeters, int Skip, int Take, CancellationToken Cancel = default);
        ...
        Task<TGpsEntity> GetByLocation(double Latitude, double Longitude, CancellationToken Cancel = default);
        ...
        Task<TGpsEntity> GetByLocationInRange(double Latitude, double Longitude, double RangeInMeters, CancellationToken Cancel = default);
        ...
        Task<IPage<TGpsEntity>> GetPageByLocationInRange(double Latitude, double Longitude, double RangeInMeters, int PageNumber, int PageSize, CancellationToken Cancel = default);
        ...
        Task<TGpsEntity> DeleteByLocation(double Latitude, double Longitude, CancellationToken Cancel = default);
        ...
        Task<TGpsEntity> DeleteByLocationInRange(double Latitude, double Longitude, double RangeInMeters, CancellationToken Cancel = default);
    }

    /// <summary>Репозиторий сущностей с определенным географическим положением</summary>
    /// <typeparam name="TGpsEntity">Тип сущности с определенным географическим положением</typeparam>
    public interface IGPSRepository<TGpsEntity> : IGPSRepository<TGpsEntity, int> where TGpsEntity : IGPSEntity<int> { }
}
