...
namespace DAL.SqlServer
{
    ...
    public static class Registrator
    {
        ...
        public static IServiceCollection AddTestDbContextSqlite(this IServiceCollection services, string ConnectionString) =>
            services
               .AddDbContext<TestContext>(opt => opt.UseSqlite(ConnectionString, o => o.MigrationsAssembly(typeof(Registrator).Assembly.FullName)))
        ...
        /// <param name="ConnectionString">Строка подключения к серверу</param>
        /// <returns>Коллекция сервисов</returns>
        public static IServiceCollection AddTestDbContextFactorySqlite(this IServiceCollection services, string ConnectionString)
        {
            services.AddDbContextFactory<TestContext>(
                opt => opt.UseSqlite(ConnectionString, o => o.MigrationsAssembly(typeof(Registrator).Assembly.FullName)));
